...
public class SelectAvatarFragment extends Fragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        ctx=(fromSelectAvatar) getActivity();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        iv_male.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ctx.selectedAvatar(false);
            }
        });
        iv_female.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ctx.selectedAvatar(true);
            }
        });
        return v;
    }
    public interface fromSelectAvatar{
         void selectedAvatar(Boolean isFemale);
    }
